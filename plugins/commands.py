...
main_buttons = [[
        InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/mrz_bot_admin_bot')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/XBOTSUPPORTS'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/botuptest')
        ],[
...
@Client.on_callback_query(filters.regex(r'^sorce'))
async def sorce(bot, query):
    await query.message.edit_text(
        text=Translation.SCORCE,
        reply_markup=InlineKeyboardMarkup(
            [[            
...
async def about(bot, query):
    await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('↩ Back', callback_data='back'),InlineKeyboardButton('Source Code', callback_data='sorce')]]),
        disable_web_page_preview=True,
